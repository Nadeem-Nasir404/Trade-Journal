        ...
        {!selectedExchange ? (
          <div className="space-y-5 px-6 py-5">
            <div>
              ...
              <p className="mb-3 text-lg text-slate-300"><span className="mr-2 text-sky-400">•</span>Centralized Exchanges (CEX)</p>
            ...
            <div>
              <p className="mb-3 text-lg text-slate-300"><span className="mr-2 text-emerald-400">•</span>Decentralized Exchanges (DEX)</p>
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                {DEX.map((item) => (
                  <button
                    key={item.name}
