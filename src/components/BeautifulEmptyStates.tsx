  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-white px-6 py-16 text-center dark:border-slate-700 dark:bg-slate-900/50">
      <div className="relative mb-5">
        ...
        <div className="absolute -right-1 -top-1 rounded-full bg-emerald-500 p-1.5 text-white"><Sparkles className="h-3.5 w-3.5" /></div>
      </div>
...
export function JournalEmptyState({ onNewEntry }: { onNewEntry: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-white px-6 py-16 text-center dark:border-slate-700 dark:bg-slate-900/50">
      <div className="mb-4 rounded-full border-4 border-purple-200 bg-gradient-to-br from-purple-50 to-pink-50 p-8 text-5xl">💜</div>
      ...
      <button onClick={onNewEntry} className="mt-6 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-purple-500 to-pink-600 px-6 py-3 font-semibold text-white shadow-lg shadow-purple-500/30 transition hover:from-purple-600 hover:to-pink-700">
        <Plus className="h-4 w-4" />
        Create First Entry
      </button>
    </div>
